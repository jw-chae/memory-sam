...
def build_app(predictor, default_results_dir: str):
    ...
    with gr.Blocks(title="Memory-SAM Submit UI") as demo:
        gr.Markdown(
            """
            # Memory-SAM Submit UI
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Launch the Memory-SAM submit Gradio UI.")
    parser.add_argument("--memory-dir", default="mt_sam_submit/user_memory")
    parser.add_argument("--results-dir", default="mt_sam_submit/results")
    parser.add_argument("--sam-checkpoint", default="mt_sam_submit/checkpoints/sam2.1_hiera_large.pt")
