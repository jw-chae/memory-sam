...
- Public release samples: 2,334
- Paper benchmark size: 2,155
- Note: the public dataset was expanded after the paper experiments.
- Image size: 512×512
